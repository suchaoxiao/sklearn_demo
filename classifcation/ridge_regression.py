# Classification of text documents using sparse features  稀疏矩阵 文本分类
import logging
import numpy as np
...
print('%d categorical'%len(target_names))
print()
...
results=[]
for clf,name in (
        (RidgeClassifier(tol=1e-2,solver='sgd'),'ridge classifier'),
